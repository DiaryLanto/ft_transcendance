...
blog_router.post("/", auth_validation, validateBlogUpdate, error_checker, createBlog);
blog_router.get("/", auth_validation, getAllBlog);
blog_router.get("/:blogId", handleGetOneBlog);
blog_router.patch("/:blogId", auth_validation, validateBlogUpdate, error_checker, handleBlogUpate);
blog_router.delete("/:blogId", auth_validation, handleBlogDelete);
